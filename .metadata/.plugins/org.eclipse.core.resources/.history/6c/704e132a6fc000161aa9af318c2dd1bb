...
/*
		...
		System.out.println("je suis la \n");
		mutex.P();
		Message m = (Message)tampon[index_lecture];
		if(((MessageX)m).get_nbExemplaires()>0) //on peut lire le message
		{
			//synchrone.P();
			((MessageX)m).set_nbExemplaires(((MessageX)m).get_nbExemplaires()-1);
			
		}
		if(((MessageX)m).get_nbExemplaires()==0)
		{
			synchrone.V();
...
>>>>>>> bf67f4b20e552372e300602ef899230b9c11ebd9
...
=======
		...
		*/
		 ...
		 */
>>>>>>> e3e874809cc3d2ee486e1e6647e9db9fb20ba5e2
	}
